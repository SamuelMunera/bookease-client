    ...
    <>
      <section className="legal-section">
        <p className="legal-intro">
          Al acceder o usar Slotly aceptas estos términos en su totalidad. Si no estás de acuerdo, no uses la plataforma.
          Estos términos se rigen por la legislación de la República de Colombia.
        </p>
      </section>

      <section className="legal-section">
        <h2>1. Qué es Slotly</h2>
        <p>Slotly es una plataforma digital que conecta clientes con negocios de estética, bienestar y cuidado personal (barberías, spas, salones y similares), permitiendo reservar citas con profesionales de forma rápida y en tiempo real.</p>
        <p>Slotly actúa como intermediario tecnológico. No es parte del servicio prestado entre el cliente y el negocio o profesional, ni garantiza la disponibilidad permanente de ningún negocio registrado.</p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>Las reservas quedan pendientes hasta que el negocio o profesional las confirme. Una reserva confirmada es un compromiso entre el cliente y el negocio; Slotly facilita la gestión pero no es responsable si el servicio no se presta por causas ajenas a la plataforma.</p>
        <div className="legal-list">
          {[
            ...
            'Slotly no gestiona pagos ni reembolsos directamente; eso corresponde al negocio según lo dispuesto en la Ley 1480 de 2011 (Estatuto del Consumidor).',
          ].map((t, i) => (
      ...
      <section className="legal-section">
        ...
        <p>Slotly no intermedia en disputas económicas entre clientes y negocios, pero pone a disposición los canales de contacto para facilitar la resolución.</p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>Los profesionales vinculados a un negocio gestionan su disponibilidad y sus servicios asignados. Slotly no verifica titulaciones ni garantiza la calidad del servicio prestado.</p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>El diseño, código, marca y contenidos de Slotly son propiedad de sus creadores y están protegidos por la legislación colombiana sobre derechos de autor y propiedad intelectual. No puedes copiarlos, redistribuirlos ni usarlos con fines comerciales sin autorización expresa.</p>
      ...
      <section className="legal-section">
        ...
        <p>El responsable del tratamiento es Slotly. Para ejercer tus derechos de <em>habeas data</em> escríbenos a <strong>privacidad@slotly.app</strong>.</p>
      </section>

      <section className="legal-section">
        <h2>9. Limitación de responsabilidad</h2>
        <p>Slotly no se hace responsable de daños derivados del incumplimiento de citas por parte de negocios o profesionales, de la inexactitud de la información publicada por terceros, ni de interrupciones técnicas fuera de nuestro control.</p>
      ...
      <section className="legal-section">
        <h2>12. Contacto</h2>
        <p>Para cualquier consulta relacionada con estos términos puedes escribirnos a <strong>legal@slotly.app</strong>.</p>
      </section>
    </>
  );
}
...
function TermsUS() {
  return (
    <>
      ...
      <section className="legal-section">
        <h2>1. Qué es Slotly</h2>
        <p>Slotly es un mercado digital que conecta clientes con negocios de cuidado personal y bienestar (barberías, spas, salones y servicios similares), permitiendo reservar citas en tiempo real con profesionales.</p>
        <p>Slotly actúa exclusivamente como intermediario tecnológico. No somos parte de ningún acuerdo de servicio entre un cliente y un negocio o profesional, y no garantizamos la disponibilidad permanente de ningún negocio registrado.</p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>Declaras tener al menos <strong>18 años de edad</strong>. Slotly no recopila intencionalmente información de personas menores de 13 años, en cumplimiento de la <em>Children's Online Privacy Protection Act</em> (COPPA).</p>
      </section>

      <section className="legal-section">
        <h2>3. Reservas y citas</h2>
        <p>Las reservas quedan pendientes hasta que el negocio o profesional las confirme. Una reserva confirmada constituye un acuerdo entre el cliente y el negocio. Slotly facilita la gestión pero no es responsable de fallas en el servicio causadas por el negocio o profesional.</p>
        <div className="legal-list">
          {[
            ...
            'Slotly no procesa pagos ni emite reembolsos directamente. Las disputas de pago son entre tú y el negocio, sujetas a las leyes de protección al consumidor federales y estatales aplicables.',
          ].map((t, i) => (
            <div key={i} className="legal-list-item">
              <span className="legal-list-dot" />
              <span>{t}</span>
      ...
      <section className="legal-section">
        <h2>4. Política de cancelación</h2>
        <p>Cada negocio puede establecer su propia política de cancelación, incluyendo un período mínimo de anticipación antes de la cita. Esta política se muestra antes de confirmar la reserva. Slotly no es responsable de hacer cumplir ni de resolver disputas de cancelación entre clientes y negocios.</p>
      ...
      <section className="legal-section">
        ...
        <p>Slotly no verifica licencias ni certificaciones profesionales y no hace ninguna declaración respecto a la calidad de los servicios prestados por los negocios o profesionales listados en la plataforma.</p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>El diseño, código, marca y contenidos originales de Slotly están protegidos por las leyes de derechos de autor, marcas registradas y propiedad intelectual de los Estados Unidos. No puedes copiarlos, redistribuirlos ni usarlos con fines comerciales sin autorización expresa por escrito.</p>
        <p>Slotly cumple con la <strong>Digital Millennium Copyright Act (DMCA)</strong>. Si consideras que algún contenido en la plataforma infringe tus derechos de autor, envía una notificación a <strong>dmca@slotly.app</strong> indicando: (i) identificación de la obra protegida; (ii) identificación del material infractor; (iii) tus datos de contacto; (iv) una declaración de buena fe; y (v) tu firma.</p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>Si eres residente de California, tienes derechos adicionales bajo la <strong>California Consumer Privacy Act (CCPA)</strong>, incluyendo el derecho a saber qué datos recopilamos, el derecho a eliminar tus datos y el derecho a optar por no participar en la venta de tus datos. Para ejercer estos derechos, contáctanos en <strong>privacidad@slotly.app</strong>.</p>
      </section>

      <section className="legal-section">
        <h2>9. Exención de garantías</h2>
        <p>LA PLATAFORMA SE OFRECE <strong>"TAL CUAL"</strong> Y <strong>"SEGÚN DISPONIBILIDAD"</strong>, SIN GARANTÍAS DE NINGÚN TIPO, YA SEAN EXPRESAS O IMPLÍCITAS, INCLUYENDO, ENTRE OTRAS, LAS GARANTÍAS IMPLÍCITAS DE COMERCIABILIDAD, IDONEIDAD PARA UN FIN DETERMINADO Y NO INFRACCIÓN. SLOTLY NO GARANTIZA QUE EL SERVICIO SEA ININTERRUMPIDO, LIBRE DE ERRORES O SEGURO.</p>
      </section>

      <section className="legal-section">
        <h2>10. Limitación de responsabilidad</h2>
        <p>EN LA MÁXIMA MEDIDA PERMITIDA POR LA LEY APLICABLE, SLOTLY NO SERÁ RESPONSABLE DE DAÑOS INDIRECTOS, INCIDENTALES, ESPECIALES, CONSECUENTES NI PUNITIVOS, INCLUYENDO PÉRDIDA DE GANANCIAS, DATOS O CLIENTELA, QUE SURJAN DE O ESTÉN RELACIONADOS CON EL USO DE LA PLATAFORMA, INCLUSO SI SE HA ADVERTIDO DE LA POSIBILIDAD DE TALES DAÑOS.</p>
        <p>NUESTRA RESPONSABILIDAD TOTAL ANTE TI POR CUALQUIER RECLAMACIÓN NO EXCEDERÁ EL MAYOR DE (A) $100 USD O (B) EL MONTO PAGADO POR TI A SLOTLY EN LOS 12 MESES ANTERIORES A LA RECLAMACIÓN.</p>
      </section>
      ...
      <section className="legal-section">
        <h2>14. Contacto</h2>
        <p>Para consultas sobre estos términos, contáctanos en <strong>legal@slotly.app</strong>.</p>
      </section>
    </>
  );
}
