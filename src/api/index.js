...
const api = {
  ...
  adminUpdateBusinessPlan:     (id, plan) => request(`/admin/businesses/${id}/plan`,     { method: 'PATCH', body: JSON.stringify({ plan }) }),
  adminUpdateProfessionalPlan: (id, plan) => request(`/admin/professionals/${id}/plan`,  { method: 'PATCH', body: JSON.stringify({ plan }) }),
